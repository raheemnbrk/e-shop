...
exports.adminDashboardStatsServices = exports.adminDashboardSalesServices = void 0;
const prisma_1 = __importDefault(require("../../../shared/config/prisma"));
const adminDashboardSalesServices = async (period) => {
...
exports.adminDashboardSalesServices = adminDashboardSalesServices;
const adminDashboardStatsServices = async () => {
    const [totalOrders, totalProducts, totalCustomers, totalSellers, recentOrders, lowStockProducts, topSellingProducts, topCustomers, ordersByStatus,] = await Promise.all([
...
exports.adminDashboardStatsServices = adminDashboardStatsServices;
