    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col sm:flex-row gap-3 pt-1">
        <button
          ...
          className="flex py-3 flex-1 cursor-pointer items-center justify-center gap-2.5 rounded-lg bg-primary text-sm font-semibold text-white transition-all duration-200 hover:bg-primaryHover active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isPending ? (
        ...
        <button
          ...
          className="flex py-3 flex-1 cursor-pointer items-center justify-center gap-2.5 rounded-lg border-2 border-primary text-sm font-semibold text-primary transition-all duration-200 hover:bg-primary hover:text-white active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
        >
