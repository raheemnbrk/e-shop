      ...
      <div className="flex gap-3 mb-3.5">
        <div className="flex-1">
          ...
          <div className="relative">
            <User className="absolute left-2.5 top-1/2 -translate-y-1/2 w-4 h-4 text-text-secondary" />
            <input
              name="firstName"
              type="text"
      ...
      <div className="mb-3.5">
        ...
        <div className="relative">
          ...
          <input
            ...
            onChange={handleChange}
            placeholder="••••••••"
            className="w-full pl-8 pr-10 py-2 border border-border rounded-[7px] text-[13.5px] text-text bg-card placeholder:text-text-secondary/60 focus:outline-none focus:ring-2 focus:ring-primary/10 focus:border-primary transition-all"
          />
          <button
