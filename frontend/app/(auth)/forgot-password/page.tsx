    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-md rounded-xl border border-border bg-card p-8 shadow-sm">
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-[7px] border border-border bg-card py-2 pl-8 pr-3 text-[13.5px] text-text placeholder:text-text-secondary/60 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/10"
            />
          </div>
        </div>
        ...
        <button
          ...
          disabled={isPending}
          className={`w-full rounded-[7px] py-2.5 text-[13.5px] font-semibold text-white transition-colors ${
            isPending
