                    ...
                    {categories?.map((category: Category) => {
                        ...
                        return (
                            <div key={category.id}>
                                ...
                                <div
                                    className={`grid transition-[grid-template-rows] duration-300 ease-in-out ${expanded
                                        ? "grid-rows-[1fr]"
                                        : "grid-rows-[0fr]"
                                        }`}
                                >
                                    <div className="overflow-hidden">
                                        <div className="ml-10 border-l border-border dark:border-dark-border md:ml-14">
                                            {category.children?.map((child) => (
                                                <div
                                                    key={child.id}
                                                    className="relative flex min-h-14 items-center gap-3 px-4 py-2 pl-5 transition-colors hover:bg-background/60 dark:border-dark-border dark:hover:bg-dark-background/60 md:pl-6"
                                                >
...
function CategoryActions({
    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent
                align="end"
                className="w-36 bg-card dark:border-dark-border dark:bg-dark-card"
            >
                <DropdownMenuItem
