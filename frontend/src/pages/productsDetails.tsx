    ...
    <div className="px-6 py-4">
      <div className="flex flex-col md:flex-row gap-12">
        ...
        <div className="flex flex-col space-y-4 w-full md:w-[50%]">
          ...
          <p className="text-gray-600 py-3 border-b border-b-gray-700" >description</p>
          <div>
            ...
            <div className="flex items-center gap-6 mt-4" >
              <div className="flex items-center border border-gray-400 w-fit rounded-md font-semibold" >
                <p className="px-5 py-2 border-r border-r-gray-300 cursor-pointer">-</p>
                <p className="px-8 py-2">1</p>
                <p className="px-5 py-2 border-l border-l-gray-300 cursor-pointer">+</p>
              </div>
